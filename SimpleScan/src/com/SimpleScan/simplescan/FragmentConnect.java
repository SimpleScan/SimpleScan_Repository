...
/**
 * 
 * @author David, Tai, Kevin 
 * This fragment displays the profile both retrieved from the back-end and synced to the cloud. 
 * On this fragment, a user may change their name and view their id to share with others.
 *
 */
public class FragmentConnect extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		android_id = Secure.getString(v.getContext().getContentResolver(), Secure.ANDROID_ID);
		return v;
	}
	...
	public void onStart() {
		...
		// prepare the db manager for database interaction 
	...
	/**
	 * Loads the name of the user currently in the system, and finishes the loadig process
	 */
	...
	/**
	 * Saves profile to database and cloud, for the name that the user has editted in the text field.
	 */
	public void saveProfile() {
		...
		if (fullName.isEmpty()) {
			...
			// insert User full name and Android ID into DATABASE
